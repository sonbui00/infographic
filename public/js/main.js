var example1 = new function () {
	...
	//This function only executed when embedded in  http://www.useragentman.com/blog
	...
	function animateClipRegion(e) {	
		...
		var x =  e.pageX - mouseOffset - $clipParent.get(0).offsetLeft - 180;
		var y =  e.pageY - mouseOffsetY - $clipParent.get(0).offsetTop - 120;
		
		polyClip.transformClip($dad2012, 'translate(' + x + 'px, ' + y + 'px)');
